 ...
 * 
 */
package metodosdiretos.teste;

import java.io.BufferedReader;
import java.io.InputStreamReader;

import metodosdiretos.Cholesky;
import metodosdiretos.Gauss;
import metodosdiretos.GaussJordan;
import metodosdiretos.LU;
...
public class TestaMetodosDiretos {
	...
	public static void main(String args[]) {
		...
		while (escolha != 5) {
			...
			System.out.println("");
			System.out.println("Por favor, escolha uma das funções abaixo de acordo com o número correspondente:");
