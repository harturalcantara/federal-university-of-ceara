...
//        }
        ...
        btInversaMat.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                A = getElementos(A, paneA);
                if(A.matrixDeterminant(A.mat) == 0){
                    System.out.println("Erro, determinante! - btInversaMat");
                    AlertBox.display("Erro", "Determinante é nulo, ou seja, não possui uma matriz inversa!");
                }
                else{
