...
public class MatrizController implements Initializable {
    ...
    @FXML
    TextField txMultEscalar; //alteracao
    ...
    @FXML
    private Button btMultEscalar; //work this
    @FXML
	...
	*/
    ...
    @FXML
    private TextField colunaB;

    @FXML
    private Button setB;

    @FXML
    private Button btInversa1;
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        btMultEscalar.setOnAction(new EventHandler<ActionEvent>() { //problema: n multiplica logo de comeco
            @Override
            public void handle(ActionEvent event) {
