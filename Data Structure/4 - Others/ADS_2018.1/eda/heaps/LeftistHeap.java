...
public class LeftistHeap <K extends Comparable <K>>{
    ...
    public void insert(K newKey ){
        root = merge( new Node(newKey), root);
    }
	...
	public static void main(String[] arg) {
		LeftistHeap<String> esq = new LeftistHeap<>();
		...
		esq.inorder();
		System.out.println(esq.size());
		
		System.out.println(esq.get("algo"));
		
		
		System.out.println("FindMin(): "+ esq.findMin());
		System.out.println("DeleteMin(): "+ esq.deleteMin());
		System.out.println("FindMin(): "+ esq.findMin());
		esq.inorder();
