...
public class RWayTrie<V> implements StringMap<V> {
	...
	private void collect(Node x, String pre, String pat, LinkedList<String> lista) {
		...
		for (char c = 0; c < R; c++)
			if (next == '.' || next == c)
				collect(x.next[c], pre + c, pat, lista);
	}
	...
	public static void main(String[] args) {
		RWayTrie<String> arvore = new RWayTrie<String>();
		...
		System.out.println(arvore.rank("moeda"));
		...
		System.out.println("\nFloor of Re: " + arvore.floor("casaa"));
		...
		System.out.println("\nCeiling of Re: " + arvore.ceiling("cas"));
		System.out.println("Expected: Re");
